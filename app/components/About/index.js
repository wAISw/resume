...
export default class About extends Component {
  render() {
    return (
      <div className='detail-page about-content bl-content'>
        <div className='row-fluid'>
          <div className='col-xs-12'>
            ...
            <p>I offer a complete web solution to my clients. I can guide you through the early stages of project
              planning
              and research, help you with information architecture and user experience, design your website, and
              finally
              ...
              <div className='col-xs-12'>
                <div className='row about-us'>
                  <div className='col-xs-3'>
                    ...
                    Claritas est etiam processus dynamicus, and mutationem consuetudium lectorum. Mirum est notare
                    quam
